(function($, host, echarts) {
    ...
    function handleCounters() {
        var prefix = 'http://statictest.tf56.com/bigDataBigScreenWeb/boarddatayunan/getYunNanGoodGoingSummary?type=';
        // 货物总量 8
        // 云南省货物流入前5类 1
        // 云南省货物流出前5类 2
        var ajaxList = ('8 1 2').split(' ').map(function (v) { return $.get(prefix + v); });
